...
exec "$JAVA" $JAVA_OPTS \
    ...
    -Dorientdb.build.number="UNKNOWN@ra9065d2198411f8b5eab3bb5240c4aad67b3dbc9; 2022-08-30 10:57:28+0000" \
    -cp "$ORIENTDB_HOME/lib/orientdb-server-3.1.20.jar:$ORIENTDB_HOME/lib/*:$ORIENTDB_HOME/plugins/*" \
